...
var _user$project$Common$Model = F5(
	function (a, b, c, d, e) {
		return {state: a, token: b, server: c, headers: d, rows: e};
	});
var _user$project$Common$Flags = F4(
	function (a, b, c, d) {
		return {token: a, server: b, headers: c, rows: d};
	});
var _user$project$Common$ReconciliationState = {ctor: 'ReconciliationState'};
var _user$project$Common$DataSourcesState = {ctor: 'DataSourcesState'};
var _user$project$Common$DwcaTermsState = {ctor: 'DwcaTermsState'};
var _user$project$Common$Continue = {ctor: 'Continue'};

var _user$project$DwcaTerms$viewRowEntry = function (re) {
	var val = function () {
		var _p0 = re;
		if (_p0.ctor === 'Just') {
			return _p0._0;
...
var _user$project$DwcaTerms$viewRow = function (row) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$DwcaTerms$viewRowEntry, row));
};
var _user$project$DwcaTerms$viewRows = function (rows) {
	return A2(_elm_lang$core$List$map, _user$project$DwcaTerms$viewRow, rows);
};
var _user$project$DwcaTerms$viewHeaderEntry = function (header) {
	return A2(
...
var _user$project$DwcaTerms$viewHeaders = function (headers) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$DwcaTerms$viewHeaderEntry, headers));
};
var _user$project$DwcaTerms$view = function (model) {
	var token_url = A2(
		_elm_lang$core$Basics_ops['++'],
		'http://',
		A2(
			_elm_lang$core$Basics_ops['++'],
			model.server,
			A2(_elm_lang$core$Basics_ops['++'], '/crossmaps/', model.token)));
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href(token_url),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(token_url),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Common$Continue),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$DwcaTerms$viewHeaders(model.headers),
							_1: _user$project$DwcaTerms$viewRows(model.rows)
						}),
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$DwcaTerms$update = F2(
	function (msg, model) {
		var _p1 = msg;
		return {
			ctor: '_Tuple2',
...
var _user$project$DwcaTerms$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$DwcaTerms$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: A5(_user$project$Common$Model, _user$project$Common$DwcaTermsState, flags.token, flags.server, flags.headers, flags.rows),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
