...
var _user$project$Main$viewRowEntry = function (re) {
	var val = function () {
		var _p0 = re;
		if (_p0.ctor === 'Just') {
			return _p0._0;
...
var _user$project$Main$viewRow = function (row) {
	return A2(
		...
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Main$viewRowEntry, row));
};
var _user$project$Main$viewRows = function (rows) {
	return A2(_elm_lang$core$List$map, _user$project$Main$viewRow, rows);
};
var _user$project$Main$viewHeaderEntry = function (header) {
	return A2(
...
var _user$project$Main$viewHeaders = function (headers) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Main$viewHeaderEntry, headers));
};
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$viewHeaders(model.headers),
						_1: _user$project$Main$viewRows(model.rows)
					}),
				_1: {ctor: '[]'}
			}
		});
...
var _user$project$Main$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: A4(_user$project$Main$Model, flags.token, flags.server, flags.headers, flags.rows),
...
var _user$project$Main$NothingYet = {ctor: 'NothingYet'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"NothingYet":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
